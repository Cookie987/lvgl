...
static const pinyin_entry_t pinyin_dict[] = {
    ...
    {"de", "的地得德"},
    {"deng", "凳灯登瞪等蹬邓"},
    {"di", "第低嘀地堤嫡帝底弟抵敌涤滴笛缔蒂递"},
    {"dian", "点佃典垫奠店惦掂殿淀玷电甸碘颠"},
    {"diao", "掉刁叼吊碉调钓雕"},
    {"die", "叠爹碟蝶谍跌"},
    {"ding", "丁叮定盯订钉锭顶鼎"},
    {"diu", "丢"},
    ...
    {"hun", "婚昏浑混荤魂"},
    {"huo", "伙惑或活火祸获豁货霍"},
    {"ji", "计记冀几击剂即及鸡叽吉唧圾基妓嫉季寂寄己忌急技挤既机极棘济激畸疾祭积稽箕籍级纪继绩肌脊荠讥辑迹际集饥鲫"},
    ...
    {"lei", "儡勒垒擂泪类累蕾雷"},
    {"leng", "冷棱楞"},
    {"li", "里立丽例俐利力励历厉厘吏哩李栗梨沥漓犁狸理璃痢砾礼离篱粒荔莉隶雳鲤黎"},
    {"lia", "俩"},
    {"lian", "帘廉怜恋敛炼练联脸莲连链镰"},
    {"liang", "两亮凉晾梁粮粱良谅辆量"},
    {"liao", "僚嘹寥撩料燎疗瞭缭聊辽镣"},
    ...
    {"pou", "剖"},
    {"pu", "仆圃扑普朴浦瀑脯菩葡蒲谱铺"},
    {"qi", "七乞企其凄启嘁器奇契妻岂崎弃戚旗期柒栖棋欺歧气汽泣淇漆畦砌祈脐起迄骑鳍齐"},
    {"qia", "恰掐洽"},
    ...
    {"sheng", "剩升圣声牲生甥盛省笙绳胜"},
    {"shi", "是世事似使侍势匙十史嗜士失始实室尸屎市师式恃拭拾施时柿氏湿狮矢石示虱蚀视誓识试诗适逝释食饰驶"},
    {"shou", "兽受售守寿手授收瘦首"},
